    ...
    <div className="spending-container">
      ...
      <div className="chart-container">
        <div className="day-container">
          <div className="money-detail">$20.12</div>
        ...
        <div className="day-container">
          <div className="money-detail">$20.90</div>
          <div className="money-container"></div>
          <p>wed</p>
        </div>

        <div className="day-container">
          <div className="money-detail">$20.11</div>
          <div className="money-container"></div>
          <p>thu</p>
        </div>
        ...
        <div className="day-container">
          <div className="money-detail">$20.32</div>
          <div className="money-container"></div>
          <p>sat</p>
        </div>

        <div className="day-container">
          <div className="money-detail">$20.01</div>
          <div className="money-container"></div>
          <p>sun</p>
        </div>
      </div>
